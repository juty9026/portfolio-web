  ...
  return (
    <Wrap>
      ...
      <Content>
        <Description>
          {`
            전에 한 번 참여했었던 5GX Cloud 프로젝트에 다시 참여하게 되었습니다.
          `}
        </Description>
        <TableView
          data={[
            { title: 'ROLE', list: ['프론트엔드 개발', '백엔드 개발'] },
            {
              ...
              list: ['웹 개발', 'API 개발', '공통 모듈 개발'],
            },
          ]}
        />
        <Description>
          {`
            간단한 공지사항 / FAQ / QnA 기능을 추가했고, 백엔드 및 프론트엔드 개발을 진행했습니다.

            차트와 데이터 테이블이 있는 화면이 5개 가량 있었고, 공통적으로 사용할 데이터 필터 컴포넌트를 작성했습니다.
            각 필터 항목이 서로 의존하고, 기능 명세가 화면별로 조금씩 다르며 여러 개발자가 사용할 컴포넌트였기 때문에 여러가지를 신경쓰며 공들여 개발했습니다.
          `}
        </Description>
