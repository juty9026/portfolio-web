...
const SphericalWordCloud = ({ data, width = 0, height = 0 }) => {
  (function () {
    ...
    function X(aQ, aJ, j, aU, aT, aR, aP, aL, aI, aS, aK, aO) {
      ...
      aQ.textBaseline = 'top';
      aQ.fillStyle = j;
      if (aP) aQ.shadowColor = aP;
      if (aL) aQ.shadowBlur = aL;
      if (aI.length) {
        aQ.shadowOffsetX = aI[0];
    ...
    aa.Create = function (aU, a0, aT, a1, aZ, aY, i, aX, aP) {
      ...
      if (aR) {
        a6 = aR;
        if (aZ) a6.shadowColor = aZ;
        if (aY) a6.shadowBlur = aY;
    ...
    function Z(aN, aT, aP, aJ, aR, aS, aI) {
      ...
      aQ = aL.getContext('2d');
      if (aR) aQ.shadowColor = aR;
      if (aS) aQ.shadowBlur = aS * aJ;
      if (aI) {
        aQ.shadowOffsetX = aI[0] * aJ;
    ...
    function Y(aI, aH) {
      ...
      return (
        (j && j.getComputedStyle && j.getComputedStyle(aI, null).getPropertyValue(aH)) ||
